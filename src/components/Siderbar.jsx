...
const Sidebar = () => {
  ...
  return (
    <div>
          ...
          <div className="flex flex-col overflow-y-auto h-screen pb-16">
            ...
            <div className="flex flex-col gap-2 mt-4 ">
              <Link href="/dashboard" passHref>
                <div
                  className={`flex items-center p-2 gap-2 rounded-md hover:opacity-100 hover:bg-[#121212] transition-all duration-300 delay-75 hover:border-[#212121]
                    ${isActive("/dashboard") ? "bg-[#121212] opacity-100 border border-[#212121]" : "opacity-40 border border-transparent"}`}
                >
              ...
              <Link href="/dashboard/projects" passHref>
                <div
                  className={`flex items-center p-2 gap-2 rounded-md hover:opacity-100 hover:bg-[#121212] transition-all duration-300 delay-75 hover:border-[#212121]
                    ${isActive("/dashboard/projects") ? "bg-[#121212] opacity-100 border border-[#212121]" : "opacity-40 border border-transparent"}`}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <Link href="/dashboard/projects/tasks" passHref>
                <div
                  className={`flex items-center p-2 gap-2 rounded-md hover:opacity-100 hover:bg-[#121212] transition-all duration-300 delay-75 hover:border-[#212121]
                  ${isActive("/dashboard/projects/tasks") ? "bg-[#121212] opacity-100 border border-[#212121]" : "opacity-40 border border-transparent"}`}
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
      ...
      <div className="gap-1 pt-2 max-w-[100vw] w-full fixed  bottom-0 left-0 right-0 bg-[#171717] border-[#212121]
      md:hidden z-50 ">
        ...
        ${isActive("/dashboard") ? "bg-[#121212]" : "bg-none"}`}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path fill="currentColor" d="M2 2h5v11H2zm6 0h5v5H8zm6 0h4v16h-4zM8 8h5v5H8zm-6 6h11v4H2z"/></svg>
          <p className="text-[0.7rem] hidden sm:block opacity-100">dashboard</p>
        </button>
        </Link>
