...
const TasksPage = () => {
  ...
  return (
    <div>
      {editingTask && (
  <div className="fixed inset-0 bg-[#121212] bg-opacity-60 flex justify-center items-center z-50">
    <div className="bg-zinc-900 border border-[#212121] p-6 rounded-lg w-[400px]">
      ...
      <div className="flex-1 flex flex-col">
        <main className="w-full flex justify-center pb-[11.5rem] px-8 ">
          <div className="flex flex-col">
            <section className="flex flex-col gap-5">
              ...
              <form
                ...
                className="flex flex-col gap-3 w-[800px] mb-10"
              >
                <input
                  type="text"
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-2">
                      <button
                        ...
                        className="bg-[#171717] hover:bg-[#1212129d] p-1 rounded-[5px] border border-[#212121] cursor-pointer text-white"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => handleDelete(task.id)}
                        className="bg-[#ca1818] hover:bg-[#5b3737] p-1 rounded-[5px] border border-[#212121] cursor-pointer text-white"
                      >
                        Delete
                      </button>
                    </div>
